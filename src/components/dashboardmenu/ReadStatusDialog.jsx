                                    ...
                                    <TableBody>
                                        {readEmployees.length > 0 ? (
                                            readEmployees.map((reader, index) => {
                                                ...
                                                const employee = allEmployees.find(e => e.name === reader.empName || e.empName === reader.empName);
                                                    ...
                                                    >
                                                        <TableCell>
                                                            <Box display="flex" alignItems="center" gap={1.5}>
                                                                ...
                                                                >
                                                                    {reader.empName?.charAt(0) || reader.name?.charAt(0) || 'U'}
                                                                </Avatar>
                                                                <Box>
                                                                    <Typography variant="body2" fontWeight="medium">
                                                                        {reader.empName || reader.name || 'Unknown Employee'}
                                                                    </Typography>
                                                                    {reader.employeeID && (
                                                        ...
                                                        <TableCell>
                                                            <Chip
                                                                label={employee?.department || reader.department || 'Unknown'}
                                                                size="small"
                                                                variant="outlined"
                                                            />
                                                        </TableCell>
