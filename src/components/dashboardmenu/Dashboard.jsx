...
import EAPLfavicon from "../../assets/images/EAPLfavicon.png";
import eaplRotatingLogo from "../../assets/images/eaplRotatingLogo.avif";
...
import CareerJobManagement from "./CareerJobManagement";
...
const DashboardSidebar = ({
  ...
  const adminItems = [
    ...
    { text: "Job Management", icon: <Diversity2 />, path: "/dashboard/careers" },
  ];
    ...
    <>
      <Box
        sx={{
          ...
          // background: `url(${EAPLfavicon}) left/cover no-repeat, linear-gradient(180deg, #b0e1fa 48%, #08548b 74%)`,
          color: "white",
          position: "relative",
          textAlign: "center",
          alignContent: "center",
      ...
      `,
              background:
                "radial- gradient(circle, rgb(255 0 0 / 0 %), rgb(0 29 48 / 16 %))",
    ...
    `}
        ...
        <Box display="flex" alignItems="center" gap={2}>
          <Box sx={{ flex: 1, minWidth: 0 }}>
            <Typography
              ...
              fontWeight="bold"
              noWrap
              sx={{ fontSize: { xs: "0.95rem", md: "1rem", lg: "1rem" } }}
            >
      ...
      <Box
        sx={{
          p: 2,
          background:
            "linear-gradient(180deg, #276d9e 0%, rgba(112, 65, 158, 0.8) 100%)",
          flexGrow: 1,
        }}
      >
        <List sx={{ px: 1 }}>
      ...
      >
        <Button
          ...
          sx={{
            ...
            fontSize: { xs: "0.85rem", md: "0.95rem" },
            background:
              "linear-gradient(180deg, #001b35 0%, rgba(112, 65, 158, 0.8) 100%)",
            color: "white",
            "&:hover": {
              background:
                "linear-gradient(180deg, rgba(112, 65, 158, 0.8) 0%,#001b35 100%)",
              transform: "translateX(2px)",
            },
          }}
        >
...
const Dashboard = () => {
  ...
  const getPageTitle = () => {
    switch (true) {
      ...
      case path.includes("careers"):
        return "Job Vacancy & Careers";
      default:
        return "Dashboard";
    }
  };
  ...
  const renderContent = () => {
    switch (path) {
      ...
      case "/dashboard/profile":
        return <Profile />;
      case "/dashboard/careers":
        return <CareerJobManagement />;
      case "/dashboard":
      default:
        return (
          <DashboardHome
    ...
    >
      ...
      >
        <AppBar
          ...
          sx={{
            background:
              "linear-gradient(to right, #b0e1fa 10%, rgb(23, 147, 169) 60%)",
